...
* `metadata(rse)`
* `colData(rse)`
* `scale_counts(rse)` TODO
* junction-specific notes
* collection vs data source
...
* `file_locate_url()` and `file_locate_url_annotation()` can be used to get the full list of URLs
* `available_projects()` will show the data you have locally
* `file_retrieve()` won't cache the data

## Other related tools

* mention snapcount
* mention again the main documentation website
