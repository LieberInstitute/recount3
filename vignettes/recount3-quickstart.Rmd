...
Using TODO you can scale the counts and assign them to the "counts" slot to use them in downstream packages such as `r Biocpkg('DESeq2')` and `r Biocpkg('limma')`.
